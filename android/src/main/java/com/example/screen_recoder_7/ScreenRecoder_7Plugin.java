package com.example.screen_recoder_7;
...
/** screen_recoder_7 */
public class Screenrecoder7 implements FlutterPlugin, ActivityAware, MethodCallHandler,
    ...
    public static void registerWith(Registrar registrar) {
        final Screenrecoder7 instance = new Screenrecoder7();
    ...
    private void setupChannels(BinaryMessenger messenger, Activity activity) {
        ...
        channel = new MethodChannel(messenger, "screen_recoder_7");
