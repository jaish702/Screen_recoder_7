...
public class SwiftScreenRecoder_7Plugin: NSObject, FlutterPlugin {
  ...
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "screen_recoder_7", binaryMessenger: registrar.messenger())
    let instance = SwiftScreenRecoder_7Plugin()
